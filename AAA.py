...
inserisci questo elenco puntato: Età: 8 - 12 anni,Livello: Middle School   Primary ,Durata: 45 minuti,Materiali:Image of climatic zones on Earth,Thread,Tape,Glue/sellotape,Ball/Balloon,Scissors,Marker /pencil,Two circular cut-outs (labelled ‘N’ and ‘S’),Labels (braille or printed).
Restituiscimi sempre un piccolo riassunto dell'attività.
